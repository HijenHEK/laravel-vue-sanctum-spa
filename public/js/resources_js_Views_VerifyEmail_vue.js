...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    verify: function verify() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().post('/api/verify-email/' + this.id + '/' + this.hash).then(function (res) {
        _this.success = 'redirecting ...';
        setTimeout(function () {
          _this.$router.push({
            name: 'home'
          });
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  /* PROPS */
  , ["content"])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" <div v-if=\"error\" class=\"md:w-10/12 md:p-2 w-full mx-auto text-sm text-red-500 text-white text-center\">\n                        {{error}}\n                    </div> "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)("div", _hoisted_7, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)("button", {
    onClick: _cache[3] || (_cache[3] = function () {
      return $options.verify && $options.verify.apply($options, arguments);
    }),
    "class": 'p-3 rounded-sm text-white' + (!$data.error ? ' bg-blue-500 hover:bg-blue-600' : 'bg-red-300 hover:bg-red-500')
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.error ? 'Oops ! Resend' : 'Click to Verify'), 3
  /* TEXT, CLASS */
  )])])])])])]);
}
